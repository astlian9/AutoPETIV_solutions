...
def generate_heatmaps(clicks, shape, tumor_sigma=3.0, background_sigma=3.0, tumor_intensity=1.0,
...
def save_heatmaps(clicks, output, input_pet, tumor_sigma=3.0, background_sigma=3.0,
    ...
    combined_heatmap = generate_heatmaps(
    ...
    nib.save(combined_nifti, os.path.join(output, f'{input_pet.split("/")[-1].split("_0001.nii.gz")[0]}_0002.nii.gz'))
